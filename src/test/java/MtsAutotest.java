...
public class MtsAutotest {
    ...
    public void testPaymentSystemLogos() {
        try {
            List<WebElement> logos = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("*//section/div/div[2]/ul")));
    ...
    public void testServicePayment() {
        try {
            ...
            WebElement amount = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("connection-sum")));
            amount.sendKeys("10");
